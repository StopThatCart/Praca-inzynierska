...
public interface PowiadomienieRepository extends Neo4jRepository<Powiadomienie, Long> {
    ...
    @Query(value = """
        ...
        """)
    Optional<Powiadomienie> findPowiadomienieById(Long id);
    @Query(value = """
        ...
        """)
    Optional<Powiadomienie> checkIfSamePowiadomienieExists(String email, String typ, String opis);
    @Query(value = """
        MATCH path=(powiadomienie:Powiadomienie)-[r1:POWIADAMIA]->(uzyt:Uzytkownik{email: $email})
        ...
        ORDER BY powiadomienie.dataUtworzenia DESC LIMIT 1
        """)
    Optional<Powiadomienie> checkIfRozmowaPowiadomienieExists(String email,
    String typ,
    ...
    @Query(value = """
        ...
        RETURN powiadomienie, collect(nodes(path)), collect(relationships(path))
        """)
    Optional<Powiadomienie> updateData(String email, Long id,
    String avatar,
    ...
    @Query(value = """
        ...
        RETURN powiadomienie, collect(nodes(path)), collect(relationships(path))
        """)
    Optional<Powiadomienie> setPrzeczytane(String email, Long id);

    @Query(value = """
        MATCH path=(powiadomienie:Powiadomienie)-[r1:POWIADAMIA]->(uzyt:Uzytkownik{email: $email})
        SET r1.przeczytane = true
        """)
    void setAllPrzeczytane(String email);
    ...
    @Query(value = """
        ...
        """)
    Page<Powiadomienie> findPowiadomieniaOfUzytkownik(String email, Pageable pageable);
    ...
    @Query(value = """
        ...
        RETURN COUNT(r1)
        """)
    Integer getNieprzeczytaneCountOfUzytkownik(String email);
    ...
    @Query("""
        ...
        RETURN pow, r1, uzyt
        """)
    Powiadomienie addPowiadomienieToUzytkownik(String email, Powiadomienie powiadomienie);
    ...
    @Query("""
        ...
        """)
    void addGlobalCustomPowiadomienie(Powiadomienie powiadomienie, String nazwa);
    ...
    @Query("""
        ...
        CREATE (pow)-[:POWIADAMIA{przeczytane: false, ukryte: false}]->(uzyt)
        """)
    void addCustomPowiadomienieToPracownicy(Powiadomienie powiadomienie, String nazwa);
    ...
    @Query("""
        ...
        RETURN pow, r1, prac
        """)
    Powiadomienie sendZgloszenieToPracownik(Powiadomienie powiadomienie, String nazwa);
    ...
    @Query("""
        ...
        LIMIT 1
        """)
    Optional<Powiadomienie> getNajnowszeZgloszenieUzytkownika(String nazwa);
    ...
    @Query(value = """
        ...
        """)
    void ukryjPowiadomienie(String email, Long id);
    ...
    @Query(value = """
        ...
        """)
    void removePowiadomienie(String email, Long id);
