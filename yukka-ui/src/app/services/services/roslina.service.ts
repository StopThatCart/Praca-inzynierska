...
export class RoslinaService extends BaseService {
   ...
   * This method sends `application/json` and handles request body of type `application/json`.
   */
  saveRoslina2$Json$Response(params: SaveRoslina2$Json$Params, context?: HttpContext): Observable<StrictHttpResponse<string>> {
   ...
   * This method sends `application/json` and handles request body of type `application/json`.
   */
  saveRoslina2$Json(params: SaveRoslina2$Json$Params, context?: HttpContext): Observable<string> {
   ...
   */
  saveRoslina2$FormData$Response(params: SaveRoslina2$FormData$Params, context?: HttpContext): Observable<StrictHttpResponse<string>> {
   ...
   * This method sends `multipart/form-data` and handles request body of type `multipart/form-data`.
   */
  saveRoslina2$FormData(params: SaveRoslina2$FormData$Params, context?: HttpContext): Observable<string> {
