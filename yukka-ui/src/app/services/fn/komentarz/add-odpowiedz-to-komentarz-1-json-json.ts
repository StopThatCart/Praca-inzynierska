...
export function addOdpowiedzToKomentarz1$Json$Json(http: HttpClient, rootUrl: string, params: AddOdpowiedzToKomentarz1$Json$Json$Params, context?: HttpContext): Observable<StrictHttpResponse<KomentarzResponse>> {
