...
export function addOdpowiedzToKomentarz1$FormData$Json(http: HttpClient, rootUrl: string, params: AddOdpowiedzToKomentarz1$FormData$Json$Params, context?: HttpContext): Observable<StrictHttpResponse<KomentarzResponse>> {
...
addOdpowiedzToKomentarz1$FormData$Json.PATH = '/komentarze/odpowiedzi';
